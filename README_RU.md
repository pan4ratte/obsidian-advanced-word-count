...
Счётчики могут отображаться не только в строке состояния, но и во вкладке правой боковой панели, а также вы можете настроить видимость обоих способов отображения или только одного из них. Кроме того, опционально для каждой выбранной метрики можно включить предупреждения о достижении лимитов. Для этого выберите метрику в пресете и укажите лимит: при достижении ≥90% лимита метрика окрашивается в оранжевый цвет, а при достижении ≥100% окрашивается в красный цвет.
