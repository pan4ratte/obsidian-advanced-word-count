...
| Считать эмодзи Telegram как один символ | При подсчёте слов и символов, считает кастомное эмодзи Telegram — [😢](tg://emoji?id=5983380877780980112) — как один символ вместо всей Markdown-ссылки. Расширение обеспечивает поддержку эмодзи плагина «Publish to Telegram». |
