const ru = {
  ...
  limitsDesc: "Добавьте предупреждение о достижении лимита для любой включённой метрики: достижение ≥90% лимита окрашивает метрику в оранжевый цвет, а при ≥100% окрашивает в красный цвет",
